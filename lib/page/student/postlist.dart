            ...
            child: controller.posts.length > 0
                ? ListView.builder(
                    ...
                    itemBuilder: (context, i) {
                      Timestamp time = controller.posts[i]['date'];

                      String tim = time.toDate().toString().substring(0, 16);
                      var user = GetStorage().read('user');
                      var postUserId = controller.posts[i]['userid'];
                      var userId = user['id'];
                      return Card(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Divider(),
                                    Text(controller.posts[i]['text']),
                                    const SizedBox(height: 4.0),
                                    controller.posts[i]['image'] != null
                              ...
                              controller.posts[i]['image'] != null
                                  ? ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        fit: BoxFit.cover,
                                        imageUrl: controller.posts[i]['image'],
